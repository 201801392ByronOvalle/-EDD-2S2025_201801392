...
// Modificar el btnReporteRelacionesClick
...
begin
  ...
  // Procesar correos para generar relaciones (pasando la cola como parámetro)
  ProcesarCorreosParaRelaciones(MatrizRelacionesGlobal, ColaCorreosGlobal);
