...
type
  ...
  public
    procedure SetListaContactos(var lista: TListaContactos);
  end;
...
procedure TfrmAgregarContacto.SetListaContactos(var lista: TListaContactos);
begin
...
begin
  ...
  InsertarContacto(ListaContactos, usuario);
