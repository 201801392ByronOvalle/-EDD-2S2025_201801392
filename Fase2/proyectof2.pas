...
begin
  ...
  // Aquí abriríamos el formulario de registro de nuevos usuarios
end;

procedure TFormLogin.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
  // Liberar la lista global de usuarios cuando se cierra la aplicación
  // Esto se maneja en la unit UListaSimple
end;
